...
Pipeline de dados de ponta a ponta sobre ~100 mil pedidos reais de um
marketplace brasileiro, do CSV bruto a um painel em Power BI.

**Python · SQL · DuckDB · pandas · PostgreSQL · Power BI (DAX, formato PBIP)**

![Página Visão Geral do painel](docs/img/visao-geral.png)

## O problema

São 100 mil pedidos espalhados em 9 arquivos CSV, sem estrutura para responder
o que um gestor pergunta toda semana: quanto vendemos, o quê, para quem, em
quanto tempo entregamos e por que o cliente não volta.
...
O porquê de cada ferramenta está em
[pipeline.md](docs/pipeline.md#por-que-estas-ferramentas).

## Rodando o projeto

**Sem servidor:** só Python 3.11 ou mais novo (desenvolvido no 3.14). A amostra
de 3.000 pedidos já vem no repositório:
...
docs/                a documentação listada acima; img/ tem as capturas do painel
sql/
