...
| `dias_entrega`, `dias_vs_previsto` | **não aditiva** | média, porque "total de dias de entrega" não significa nada |
...
- **Dinheiro exclui cancelado, volume mostra os dois.** Receita filtra
  `eh_venda_efetiva`, com R$ 15.735.527,03 de base. P8 não filtra, porque "quanto
